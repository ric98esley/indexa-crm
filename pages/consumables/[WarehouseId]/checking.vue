<template>
  <el-container direction="vertical" class="p-3">
    ...
    <el-row :gutter="8" class="mt-4">
      <el-col :span="8">
        <el-card>
          <ConsumableFormCheck show-min @submit="addToList" />
        </el-card>
      </el-col>
      <el-col :span="16">
        <el-card>
    ...
    <el-dialog v-model="modals.save">
      <ConsumableFormLot @submit="checking" />
    </el-dialog>
  </el-container>
</template>
...
const checking = async ({ customer, description }: { customer: string; description: string }) => {
  try {
    const data = {
      customer,
      description
